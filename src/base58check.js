//"bitcoinjs-lib":"0.2.0" computed checksum using 2 sha256 hashes, this 
//file was copied and modified to encode and decode using only one hash.
//Check this again upon upgrade, beta branch used only one hash.
