...
describe('Crypto', function() {
    ...
    var password_sha512=
        "a5d69dffbc219d0c0dd0be4a05505b219b973a04b4f2cd1979a5c9fd65bc0362"+//password
        "2e4417ec767ffe269e5e53f769ffc6e1"+//initalization vector
        "6bf05796fddf2771e4dc6d1cb2ac3fcf"//discard
    ...
    var iv  = CryptoJS.enc.Hex.parse(password_sha512.substring(64,96))
    
    //console.log(password_sha512.substring(0,64)
    var key = CryptoJS.enc.Hex.parse(password_sha512.substring(0,64))
   
    // Convert data into word arrays (used by Crypto)
    var cipher = CryptoJS.enc.Hex.parse(encrypted_key)
    
    it('Decrypt master key', function() {
        // see wallet_records.cpp master_key::decrypt_key
        var decrypted = CryptoJS.AES.decrypt(
            {ciphertext:cipher,salt:null},key,{iv:iv}
        )
