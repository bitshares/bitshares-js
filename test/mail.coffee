...
signed_email_test = (msg) ->
    describe "Private Email (decrypted)", ->
        ...
        it "Parses all fields", ->
            ...
            assert.equal email.reply_to, new Buffer(msg.reply_to_hex, 'hex').toString('binary'), "reply_to message id"
            ...
            assert.equal email.signature, new Buffer(msg.signature_hex, 'hex').toString('binary'), "signature"

        it "Signature Verifiy", ->
            # remove the signature
            email_hex = Email.fromHex(msg.hex).toHex(false)
...
encrypted_mail_test = (msg) ->
    describe "Encrypted Mail (public)", ->
        describe "Parse and regenerate", ->
            it "Supports HEX", ->
        ...
        describe "Mail (private)", ->
            it "Has matching one_time_key", ->
